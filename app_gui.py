...
GREEN_TICKERS_FULL = [
    "ACMESOLAR.NS", "ADANIGREEN.NS", "JNPR.BO", "BORORENEW.NS", 
    ...
    "VIKRAMSOLR.NS", "WAAREEENER.NS", "WAAREERTL.NS", "SAATVIKGL.NS", 
     "SOLARWORLD.NS",  "GKENERGY.NS", "OLECTRA.NS", 
    "WEBELSOLAR.NS", "ADVAIT.NS", "EIEL.NS", "CLEANMAX.NS", "UTLSOLAR.BO", "JSWENERGY.NS",
    "OLECTRA.NS"
